...
class HouseholdSpecializationModelClass:
    ...
    def solve(self,do_print=False):
        ...
        def objective(x)_
            return -self.cal_utility(x[0]), x[1], x[2], x[3]) # the minus in the front is set to minimize the function
        ...
        result_cont = optimize.minimize(obj, guess, method='SLSQP', bounds=bounds, constraints=constraints)
